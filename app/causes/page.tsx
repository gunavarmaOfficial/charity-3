...
const causes = [
  ...
  },
  {
    ...
    description: "Empowering women through skill development, financial literacy, and entrepreneurship training.",
  ...
  },
  {
    ...
    description: "Installing water purification systems and building wells in water-scarce regions.",
  ...
  },
  {
    ...
    description: "Protecting local ecosystems through tree planting and waste management initiatives.",
  ...
  },
  {
    ...
    description: "Providing care and support to elderly citizens through assisted living and healthcare programs.",
              ...
              <div className="p-6">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span>₹{cause.raised.toLocaleString()} raised of ₹{cause.goal.toLocaleString()}</span>
                  </div>
                </div>
